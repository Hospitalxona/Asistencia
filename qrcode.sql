...
insert  into `asistencias`(`ida`,`user`,`fecha`,`hora`,`salida`,`id`,`created_at`,`updated_at`,`deleted_at`) values (221,'$2y$10$o6XaYn3XWHe0Jc5GHs2Wh.cGsNHJnwuIl/frA3emGUxTh3icJYuhu','2020-03-29','22:51:15','22:52:41',1,'2020-03-29 22:51:19','2020-03-29 22:51:19',NULL),(222,'$2y$10$o6XaYn3XWHe0Jc5GHs2Wh.cGsNHJnwuIl/frA3emGUxTh3icJYuhu','2020-03-29','22:52:08','22:52:59',7,'2020-03-29 22:52:12','2020-03-29 22:52:12',NULL);
...
insert  into `calificaciones`(`id`,`title`,`ide`,`idu`,`calpre`,`calpos`,`promedio`,`estatus`,`deleted_at`,`created_at`,`updated_at`) values (97,'Hospitales verdes',9,22,10,9,9.5,'contestado',NULL,'2020-03-26 15:38:32','2020-04-14 14:25:12'),(98,'Capacitación 2020',10,22,7,7,7,'contestado',NULL,'2020-03-26 15:48:54','2020-03-30 20:08:55'),(99,'Parovirus',12,22,4,7,5.5,'contestado',NULL,'2020-03-27 14:15:36','2020-03-27 18:12:13'),(100,'Tratamiento Opstetrico',11,22,2,9,5.5,'contestado',NULL,'2020-03-27 14:19:21','2020-03-30 20:09:29'),(101,'Protocolo H3',13,22,10,10,10,'contestado',NULL,'2020-03-29 12:39:30','2020-03-29 14:07:06'),(102,'Procedimiento quirurgico',14,22,7,8,7.5,'contestado',NULL,'2020-03-29 12:49:00','2020-03-29 13:00:10');
...
insert  into `details`(`id`,`idu`,`ide`,`respuesta`) values (1,22,7,'si'),(3,23,7,'si');
...
insert  into `examens`(`id`,`title`,`iframe`,`status`,`tipo`,`deleted_at`,`created_at`,`updated_at`) values (9,'Hospitales verdes','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSeJFMbi3zjmd2cqKf4MTh7cg7v7rYxVQ6hjlVDHWxvK-cb88A/viewform?embedded=true\" width=\"640\" height=\"248\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pre',NULL,'2020-03-25 22:31:03','2020-03-26 00:05:38'),(10,'Capacitación 2020','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSe-iSh8MEzyMBb9_CRZAafDAkKnnwyrNlDGyfoAndobIyQ3nw/viewform?embedded=true\" width=\"640\" height=\"414\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pre',NULL,'2020-03-25 23:17:00','2020-03-26 13:39:34'),(11,'Tratamiento Opstetrico','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSe-iSh8MEzyMBb9_CRZAafDAkKnnwyrNlDGyfoAndobIyQ3nw/viewform?embedded=true\" width=\"640\" height=\"414\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pre',NULL,'2020-03-25 23:53:07','2020-03-26 13:40:44'),(12,'Parovirus','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSe-iSh8MEzyMBb9_CRZAafDAkKnnwyrNlDGyfoAndobIyQ3nw/viewform?embedded=true\" width=\"640\" height=\"414\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pre',NULL,'2020-03-26 00:04:22','2020-03-26 13:40:46'),(13,'Protocolo H3','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSfQieD8KmLvoQ0tgTVhuT_bkDc9oBvALc6bc_ItnSUIeF67pA/viewform?embedded=true\" width=\"640\" height=\"248\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pos',NULL,'2020-03-29 12:31:43','2020-03-29 12:32:38'),(14,'Procedimiento quirurgico','<iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSfQieD8KmLvoQ0tgTVhuT_bkDc9oBvALc6bc_ItnSUIeF67pA/viewform?embedded=true\" width=\"640\" height=\"248\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">Cargando…</iframe>','Activo','pos',NULL,'2020-03-29 12:32:30','2020-03-29 12:36:03');
...
insert  into `migrations`(`id`,`migration`,`batch`) values (13,'2014_07_02_230147_migration_cartalyst_sentinel',1),(14,'2017_05_05_084634_PasswordReset',1),(15,'2020_03_11_221845_capacitaciones',1),(16,'2020_03_12_234435_Asistencias',1),(18,'2020_03_19_111640_create_events_table',2),(27,'2020_03_22_150244_examens',4),(36,'2020_03_23_181352_calificaciones',5);
...
/*View structure for view calis */

/*!50001 DROP TABLE IF EXISTS `calis` */;
/*!50001 DROP VIEW IF EXISTS `calis` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `calis` AS select `cal`.`id` AS `id`,`cal`.`title` AS `examen`,`ex`.`tipo` AS `tipo`,concat(`us`.`first_name`,' ',`us`.`last_name`) AS `usuario`,`cal`.`calpre` AS `calpre`,`cal`.`calpos` AS `calpos`,`cal`.`promedio` AS `promedio` from ((`calificaciones` `cal` join `users` `us` on((`us`.`id` = `cal`.`idu`))) join `examens` `ex` on((`ex`.`id` = `cal`.`ide`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `listaases` AS select `asi`.`ida` AS `ida`,`us`.`first_name` AS `Nombre`,`us`.`last_name` AS `apellido`,`us`.`email` AS `correo`,`ro`.`name` AS `role`,`asi`.`fecha` AS `fecha`,`asi`.`hora` AS `hora`,`asi`.`salida` AS `salida`,`ca`.`id` AS `id`,`ca`.`nombre` AS `capacitacion` from ((((`asistencias` `asi` join `capacitaciones` `ca` on((`ca`.`id` = `asi`.`id`))) join `users` `us` on((`us`.`QRpassword` = `asi`.`user`))) join `role_users` `ru` on((`ru`.`user_id` = `us`.`id`))) join `roles` `ro` on((`ro`.`id` = `ru`.`role_id`))) */;
